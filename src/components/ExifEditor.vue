    ...
    <n-form label-placement="left" label-width="auto" :model="form">
      <n-grid :cols="2" :x-gap="16">
        <n-form-item-gi label="相机制造商">
          <n-input v-model:value="form.cameraMake" placeholder="如 Canon" />
        </n-form-item-gi>
        <n-form-item-gi label="相机型号">
          <n-input v-model:value="form.cameraModel" placeholder="如 EOS R5" />
        </n-form-item-gi>
        <n-form-item-gi label="镜头">
          <n-input v-model:value="form.lens" placeholder="如 RF 50mm F1.2L USM" />
        </n-form-item-gi>
